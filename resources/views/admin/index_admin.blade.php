                                ...
                                <div class="home-userhead">
                                    ...
                                    <div class="home-useraction">
                                        ...
                                        <ul class="dropdown-menu" data-popper-placement="bottom-end">
                                            <li>
                                                <a href="{{ url('admin/user-list') }}" class="dropdown-item"> View</a>
                                            </li>
                                            <li>
                            ...
                            <div class="home-user home-provider">
                                <div class="home-userhead">
                                    ...
                                    <div class="home-useraction">
                                        ...
                                        <ul class="dropdown-menu" data-popper-placement="bottom-end">
                                            <li>
                                                <a href="{{ url('admin/user-providers') }}" class="dropdown-item"> View</a>
                                            </li>
                                            <li>
                                                <a href="{{ url('admin/edit-provider') }}" class="dropdown-item"> Edit</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>
                                                    <a href="{{ url('admin/view-service') }}" class="table-imgname">
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td>
                                                    <a href="{{ 'admin/view-service' }}" class="table-imgname">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/view-service') }}" class="table-imgname">
                                                        <img src="{{ URL::asset('/admin_assets/img/services/service-10.jpg') }}"
                                                            class="me-2" alt="img">
                                                        <span>Interior </span>
                                                    </a>
                                                </td>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="home-user">
                                <div class="home-head-user home-graph-header">
                                    <h2>Top Providers</h2>
                                    <a href="{{ url('admin/user-providers') }}" class="btn btn-viewall">View All<img
                                            src="{{ URL::asset('/admin_assets/img/icons/arrow-right.svg') }}"
                                            class="ms-2" alt="img"></a>
                                </div>
                                <div class="table-responsive datatable-nofooter">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="bookingmap">
                                                <ul>
                                                    <li>
                                                        <span><img
                                                                src="{{ URL::asset('/admin_assets/img/flags/us.png') }}"
                                                                alt="img" class="me-2">United State</span>
                                                        <h6>60%</h6>
                                                    </li>
                                                    <li>
                                                        <span><img
                                                                src="{{ URL::asset('/admin_assets/img/flags/in.png') }}"
                                                                alt="img" class="me-2">India</span>
                                                        <h6>80%</h6>
                                                    </li>
                                                    <li>
                                                        <span><img
                                                                src="{{ URL::asset('/admin_assets/img/flags/ca.png') }}"
                                                                alt="img" class="me-2">Canada</span>
                                                        <h6>50%</h6>
                                                    </li>
                                                    <li>
                                                        <span><img
                                                                src="{{ URL::asset('/admin_assets/img/flags/au.png') }}"
