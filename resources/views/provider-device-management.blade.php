<?php $page = 'provider-device-management'; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 mx-auto">
                        <div class="login-back manage-log">
                            <a href="{{ url('provider-security-settings') }}"><i class="feather-arrow-left"></i> Back</a>
                        </div>
                                ...
                                <table class="table custom-table datatable mb-0" id="data-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Newyork / USA</td>
                                            <td>333.555.10.54</td>
                                            <td><a href="javascript:;"><span class="badge-danger">Delete</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
